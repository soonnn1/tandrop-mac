...
class _TranslationsWebSharePageUk extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'TanDrop використовує самопідписаний сертифікат. Вам потрібно прийняти його в браузері.';
  @override
...
class _TranslationsAboutPageUk extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Про TanDrop';
  @override
  List<String> get description => [
        'TanDrop — це безплатна програма з відкритим вихідним кодом, яка дозволяє вам безпечно обмінюватися файлами та повідомленнями з пристроями поблизу через локальну мережу, без необхідності підключення до Інтернету.',
...
class _TranslationsDonationPageUk extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'TanDrop — це безплатна програма з відкритим вихідним кодом та без реклами. Якщо вона вам подобається, ви можете підтримати її розробку пожертвою.';
  @override
...
class _TranslationsTrayUk extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Вийти з TanDrop';
  @override
...
class _TranslationsNetworkInterfacesPageUk extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Типово TanDrop використовує всі доступні мережеві інтерфейси. Ви можете виключити небажані мережі тут. Щоб застосувати зміни, потрібно перезапустити сервер.';
}
...
class _TranslationsSettingsTabGeneralUk extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Відображати TanDrop в контекстному меню';
  @override
...
class _TranslationsSettingsTabOtherUk extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Підтримати TanDrop';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedUk extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'TanDrop не може знайти інші пристрої без дозволу на сканування локальної мережі. Будь ласка, надайте цей дозвіл у налаштуваннях.';
  @override
...
class _TranslationsDialogsSendModeHelpUk extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Отримувачі, у яких не встановлено TanDrop, можуть завантажити вибрані файли, відкривши посилання у своєму браузері.';
}
