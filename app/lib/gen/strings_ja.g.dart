...
class _TranslationsReceiveOptionsPageJa extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(TanDrop フォルダー)';
  @override
...
class _TranslationsWebSharePageJa extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'TanDropは自己署名証明書を使用しているため、ブラウザーで証明書を許可する必要があります。';
  @override
...
class _TranslationsAboutPageJa extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'TanDropについて';
  @override
  List<String> get description => [
        'TanDropは無料のオープンソースアプリで、インターネットに接続することなく、ローカルネットワーク経由で近くにあるデバイスとファイルやメッセージを安全に共有することができます。',
...
class _TranslationsDonationPageJa extends TranslationsDonationPageEn {
  ...
  String get title => '寄付';
  @override
  String get info => 'TanDropは無料かつオープンソースで、広告を一切含みません。もしアプリを気に入っていただけたら、寄付で開発を支援することができます。';
  @override
...
class _TranslationsSettingsTabGeneralJa extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'コンテキストメニューにTanDropを表示';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedJa extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'ローカルネットワークをスキャンする権限がないと、TanDropは他のデバイスを見つけることができません。設定よりこの権限を付与してください。';
  @override
...
class _TranslationsDialogsSendModeHelpJa extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'TanDropをインストールしていない受信者でも、ブラウザでリンクを開くことで選択したファイルをダウンロードできます。';
}
