...
class _TranslationsReceiveOptionsPageHe extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(תיקיית TanDrop)';
  @override
...
class _TranslationsWebSharePageHe extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'TanDrop משתמש בתעודה עצמית. עליך לאשר אותה בדפדפן.';
  @override
...
class _TranslationsAboutPageHe extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'אודות TanDrop';
  @override
  List<String> get description => [
        'TanDrop היא אפליקציית קוד פתוח חינמית המאפשרת לשתף קבצים והודעות בצורה מאובטחת עם מכשירים קרובים דרך הרשת המקומית מבלי להזדקק לחיבור לאינטרנט.',
...
class _TranslationsDonationPageHe extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'אפליקציית TanDrop היא חינמית, קוד פתוח וללא פרסומות. אם אתה אוהב את האפליקציה, אתה יכול לתמוך בפיתוח באמצעות תרומה.';
  @override
...
class _TranslationsNetworkInterfacesPageHe extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'כברירת מחדל, TanDrop משתמש בכל ממשקי הרשת הזמינים. באפשרותך להסיר רשתות שאינן רצויות כאן. עליך להפעיל מחדש את השרת כדי להחיל את השינויים.';
  @override
  String get preview => 'תצוגה מקדימה';
  @override
...
class _TranslationsSettingsTabGeneralHe extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'הצג את TanDrop בתפריט ההקשר';
  @override
...
class _TranslationsSettingsTabOtherHe extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'תמיכה ב-TanDrop';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedHe extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'ל־TanDrop אין אפשרות למצוא מכשירים אחרים ללא הרשאה לסריקת הרשת המקומית. אנא הענק את ההרשאה הזו בהגדרות.';
  @override
...
class _TranslationsDialogsSendModeHelpHe extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'מקבלים ש-TanDrop לא מותקן אצלם יוכלו להוריד את הקבצים שנבחרו על ידי פתיחת הקישור בדפדפן שלהם.';
}
