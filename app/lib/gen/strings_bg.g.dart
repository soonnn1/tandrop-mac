...
class _TranslationsReceiveOptionsPageBg extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(TanDrop папка)';
  @override
...
class _TranslationsWebSharePageBg extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'TanDrop използва самоподписан сертификат. Трябва да го приемете във вашия браузър.';
  @override
...
class _TranslationsAboutPageBg extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Относно TanDrop';
  @override
  List<String> get description => [
        'TanDrop е безплатно приложение с отворен код, което ви позволява сигурно да споделяте файлове и съобщения с устройства наблизо през вашата локална мрежа, без да се нуждаете от интернет връзка.',
...
class _TranslationsDonationPageBg extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'TanDrop е безплатен, с отворен код и без никакви реклами. Ако харесвате приложението, можете да подкрепите разработката с дарение.';
  @override
...
class _TranslationsTrayBg extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Излезте от TanDrop';
  @override
...
class _TranslationsNetworkInterfacesPageBg extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'По подразбиране, TanDrop използва всички налични мрежови интерфейси. Тук можете да изключите нежелани мрежи. Трябва да рестартирате сървъра, за да приложите промените.';
}
...
class _TranslationsSettingsTabGeneralBg extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Показване на TanDrop в контекстното меню';
  @override
...
class _TranslationsSettingsTabOtherBg extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Поддръжка на TanDrop';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedBg extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'TanDrop не може да намери други устройства, без да има разрешение за сканиране на локалната мрежа. Моля, дайте това разрешение в настройките.';
  @override
...
class _TranslationsDialogsSendModeHelpBg extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Получателите, които нямат инсталиран TanDrop, могат да изтеглят избраните файлове, като отворят връзката в своя браузър.';
}
