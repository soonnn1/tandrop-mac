...
class _TranslationsReceiveOptionsPageMn extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(TanDrop-н хавтас)';
  @override
...
class _TranslationsWebSharePageMn extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'TanDrop нь өөрийн гарын үсэг ашигладаг тул үүнийг browser дээрээ хүлээн зөвшөөрнө үү.';
  @override
...
class _TranslationsAboutPageMn extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'TanDrop танилцуулга';
  @override
  List<String> get description => [
        'TanDrop нь үнэгүй, нээлттэй эхийн програм бөгөөд танд интернет холболт шаардлагагүйгээр өөрийн дотоод сүлжээгээр ойролцоох төхөөрөмжүүдтэй файл, мессежийг аюулгүйгээр хуваалцах боломтой.',
...
class _TranslationsDonationPageMn extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'TanDrop нь үнэ төлбөргүй, нээлттэй эх сурвалжтай бөгөөд ямар ч зар сурталчилгаагүй. Хэрэв энэ програм таалагдсан бол хандивын мөнгөөр хөгжлийг дэмжих боломжтой.';
  @override
...
class _TranslationsSettingsTabGeneralMn extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Системийн цэсэнд TanDrop-д харуулах';
  @override
...
class _TranslationsSettingsTabOtherMn extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'TanDrop-г дэмжих';
  @override
